...
class PViT_seg(nn.Module):
    ...
    def forward_features(self, x, cls_label):
        ...
        center,group_input_tokens = self.encoder(x)  # B G N
...
def build_promptmodel_seg(num_classes=50, model_idx='ViT', base_model='vit_base_patch16_224_in21k',normal = False):
