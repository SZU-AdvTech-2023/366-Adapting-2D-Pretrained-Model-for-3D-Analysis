...
class Attention(nn.Module):
    ...
    def forward(self, x, temp=1.0):
        #batch,n,d
        B, N, C = x.shape
        #qkv(x) ---> b,n,3c  rehape b,n,3,head,head_d --- > permute 3,b,num_heads,n,dim
...
class VisionTransformer(nn.Module):
    ...
    """
    # 10000 ---- >  100 x 100 ----> 5个token
    def __init__(self, img_size=224, patch_size = 16, in_chans=3, num_classes=40, embed_dim=768, depth=12,
