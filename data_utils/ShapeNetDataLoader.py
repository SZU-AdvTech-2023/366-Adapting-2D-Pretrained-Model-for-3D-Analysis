...
class PartNormalDataset(Dataset):
    ...
    def __init__(self,root = '/home/ubuntu/p3/data/shapenetcore_partanno_segmentation_benchmark_v0_normal', npoints=2500, split='train', class_choice=None, normal_channel=False):
...
if __name__ == '__main__':
    root = '/home/ubuntu/p3/data/shapenetcore_partanno_segmentation_benchmark_v0_normal'
    ...
    for point_set, cls, seg in trainDataLoader:
