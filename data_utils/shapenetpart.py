...
if __name__ == '__main__':
    ...
    TRAIN_DATASET = ShapeNetPartNormal(num_points=2048, split='trainval', transform=train_transforms,
                                       presample=True)
    trainDataLoader = torch.utils.data.DataLoader(TRAIN_DATASET, batch_size=16, shuffle=True,
                                                  num_workers=10, drop_last=True)
    TEST_DATASET = ShapeNetPartNormal(num_points=2048, split='test', transform=val_transforms, presample=True)
